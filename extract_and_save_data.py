...
if __name__ == "__main__":
  ...
  client = connect_mongo("mongodb+srv://gabrieljanisky:LwJBSzy7bysEi1r6@cluster-pipeline.mxxzk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster-pipeline")
  db = create_connect_db(client, "db_challenge")
  col = create_connect_collection(db, "challenge")
